...
int main() {
    int result = test_pim_square_prime_number_of_dpus();
    if (result == 0) {
        printf("[PASS] test_pim_square_prime_number_of_dpus passed!\n");
        return 0;
    } else {
        printf("[FAIL] test_pim_square_prime_number_of_dpus failed!\n");
        return 1;
    }
}
