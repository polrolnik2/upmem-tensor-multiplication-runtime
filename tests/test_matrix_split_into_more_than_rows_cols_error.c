...
int main() {
    int result = test_matrix_split_into_more_than_rows_cols_error();
    if (result == 0) {
        printf("[PASS] test_matrix_split_into_more_than_rows_cols_error passed!\n");
        return 0;
    } else {
        printf("[FAIL] test_matrix_split_into_more_than_rows_cols_error failed!\n");
        return 1;
    }
}
