// Auto-migrated from test_pim_identity_square_matrix_multiplication.c using migrate_to_gtest.py
...
TEST(MatrixTest, pim_identity_square_matrix_multiplication) {
