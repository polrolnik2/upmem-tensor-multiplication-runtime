// Auto-migrated from test_pim_transfer_misaligned_matrix_multiplication.c using migrate_to_gtest.py
...
TEST(MatrixTest, pim_transfer_misaligned_matrix_multiplication) {
