// Auto-migrated from test_matrix_split_into_more_than_rows_cols_error.c using migrate_to_gtest.py
...
TEST(MatrixTest, matrix_split_into_more_than_rows_cols_error) {
    int8_t row0[] = {1, 2};
    int8_t row1[] = {3, 4};
